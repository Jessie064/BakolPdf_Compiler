"""
Django settings for pdf_compiler project.
...
SECRET_KEY = 'django-insecure-tx7%l9b^0nm474_9&uhw%&os$^*wzdkduj3p%c2v@lnyul66m='
...
ROOT_URLCONF = 'pdf_compiler.urls'
...
WSGI_APPLICATION = 'pdf_compiler.wsgi.application'
